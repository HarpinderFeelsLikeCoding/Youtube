...
if (iconString.value === 'Subscriptions') {
    icon = FolderPlayOutline
}

if (iconString.value === 'Library') {
    icon = ImageMultiple       
}

if (iconString.value === 'Liked') {
    icon = ThumbUpOutline
}

if (iconString.value === 'History') {
    icon = History
}   

if (iconString.value === 'Watch Later') {
    icon = ClockOutline
}   
